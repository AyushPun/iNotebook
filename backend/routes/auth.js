...
const jwt = require("jsonwebtoken");  //provide identification token to user (https://www.npmjs.com/package/jsonwebtoken)

//Creating a user using : POST "/api/auth/createuser". no login require
router.post(  //to avoid sending data in URL (get)
  //Endpoint
  "/createuser",
